...
#Tensorflow does not have GPU support
...
RUN wget https://repo.lentiq.com/Getting%20Started%20Guide%20%2812%29.ipynb -O /user/notebooks/Getting\ Started\ Guide.ipynb && \
